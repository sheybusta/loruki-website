...
As a **visitor** / **account owner** I want a website to be comfortable to use from smaller devices such as phone and tablet. Alina

- [ ] Given when open from smaller device then design modifies to the size of my screen.

As a **visitor** I want to know the supported languages of the platform to decide if I want to use this website. Sheyla
...
As a **content manager** I want information grouped in blocks and pages so it is easy to navigate. Sheyla

- [ ] Given information is split in blocks and pages. (blocks can be small/colors)

As a **designer** I want to have infographics so the website is easy to use. Michael
...
As a **product owner** I want the name of website to be memorable.ALina

- [ ] Given simple and original name to the website.

As a **potential client** I want success message on demo request form submission.Sheyla

   - [ ] Given succes message appears after the form is filled correctly and submitted. 
   
As a **visitor** I want all menu items or navigation links to indicate they are selected for pressing. Michael
. 
...
- As a **user** I want supported languages icons to be linked to their respective official websites. Erkam
 ...
 As a **visitor** I want a favicon to easily recognize the webpage in my browser. Mayuri
